  ...
  const pts = [
    {
      ...
      conclusion: 'NO ADECUADO. La ejecución observada no demuestra cobertura continua. Cada fallo sin reejecución representa hasta 24 horas sin copia total, incompatible con el objetivo de recuperación de los procesos que dependen del Motor Batch. Deriva a PT-OBS-05.',
    ...
    },
    {
      ...
      conclusion: 'NO ADECUADO. No se demuestra que las copias puedan restaurarse dentro de los objetivos comprometidos. La única prueba registrada, además de antigua, fue fallida y su causa no fue tratada. Deriva a PT-OBS-06.',
    ...
    },
    {
      ...
      conclusion: 'NO ADECUADO. La detección funciona pero no se traduce en tratamiento ni en cierre demostrable. Una alerta sin acción documentada no constituye un control efectivo. Refuerza PT-OBS-05.',
