  ...
  const pts = [
    {
      ...
      conclusion: 'DEFICIENTE. La vigencia y el mantenimiento del BCP no quedan demostrados dentro del ciclo exigido ni del que el propio plan establece. Deriva a PT-OBS-01.',
    ...
    },
    {
      ...
      conclusion: 'DEFICIENTE. La ausencia de un RPO cuantificado y de aprobación formal para P2 impide derivar una estrategia de resguardo exigible y verificable. Deriva a PT-OBS-02 y se cruza con PT-XC-01.',
    ...
    },
    {
      ...
      conclusion: 'DEFICIENTE. La capacidad de recuperación declarada no fue validada empíricamente en el período. Los tiempos objetivo del BIA permanecen sin verificación práctica. Deriva a PT-OBS-04.',
