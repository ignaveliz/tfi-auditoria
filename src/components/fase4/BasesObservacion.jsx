  ...
  const pts = [
    {
      ...
      conclusion: 'NO ADECUADO — soporte suficiente para elevar a observación. La Fase 5 deberá completar causa, efecto y recomendación.',
    ...
    },
    {
      ...
      conclusion: 'NO ADECUADO — soporte suficiente para elevar a observación. La Fase 5 deberá cuantificar el alcance sobre el volumen de acreditaciones expuesto y evitar tratar un valor no aprobado como vigente.',
    ...
    },
    {
      ...
      objetivo: 'Consolidar las tres condiciones no adecuadas verificadas sobre el Plan de Recuperación ante Desastres, distinguiéndolas expresamente de una hipótesis de inexistencia del documento.',
      ...
      conclusion: 'NO ADECUADO — soporte suficiente para elevar a observación. La ficha de la Fase 5 deberá reconocer expresamente la existencia del documento y abstenerse de afirmar su ausencia, por cuanto el descargo del área auditada previsiblemente invocará esa circunstancia.',
    ...
    },
    {
      ...
      conclusion: 'NO ADECUADO — soporte suficiente para elevar a observación. Los tiempos objetivo declarados permanecen sin validación empírica.',
    ...
    },
    {
      ...
      conclusion: 'NO ADECUADO — soporte suficiente para elevar a observación. La Fase 5 deberá calcular el efecto sobre el punto objetivo de recuperación una vez definido el RPO de P2, hoy pendiente conforme a PT-OBS-02.',
    ...
    },
    {
      ...
      conclusion: 'NO ADECUADO — soporte suficiente para elevar a observación. La restaurabilidad de las copias no está acreditada, con independencia de que el almacenamiento externo sí lo esté conforme a PT-OC2-02.',
    ...
    },
    {
      ...
      conclusion: 'NO ADECUADO — soporte suficiente para elevar a observación. Los tres desvíos comparten causa aparente y admiten una recomendación única, según lo previsto en la metodología de la Fase 2.',
