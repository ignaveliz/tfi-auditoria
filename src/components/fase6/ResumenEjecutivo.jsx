import { FileText, Target, CheckCircle, List, AlertTriangle, Lightbulb, Map } from 'lucide-react';

const ResumenEjecutivo = () => {
  return (
    <div>
      {/* A.1 Carta de elevación */}
      <section id="a1-carta" className="scroll-mt-24 mb-12 bg-white p-8 rounded-lg shadow-sm border border-gray-100">
        <div className="flex items-center gap-3 mb-6">
          <FileText className="h-8 w-8 text-corporate-blue" />
          <h2 className="text-2xl font-bold text-corporate-navy">A.1 Carta de elevación del informe</h2>
        </div>
